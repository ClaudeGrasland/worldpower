...
Ce cours propose de décomposer les étapes successives de création d'une base de donnée sur la puissance des pays du Monde entre 1990 et aujourd'hui à l'aide de données issues de deux API. D'une part l'API de la Banque Mondiale pour les données statistiques et d'autre part l'API Natural Earth pour le fonds de carte correspondant.
<br>
...
### Application au calcul des 10 pays les plus puissants en 1996 et 2016 
